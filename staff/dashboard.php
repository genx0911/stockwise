...
<div class="row g-3 mb-4">
    <div class="col-md-3">
        <div class="kpi-card border-blue">
            <div class="d-flex justify-content-between align-items-start mb-2">
                <div class="kpi-label mb-0">My Orders</div>
    ...
    <div class="col-md-3">
        <div class="kpi-card border-amber">
            <div class="d-flex justify-content-between align-items-start mb-2">
                <div class="kpi-label mb-0">Pending</div>
                <span style="font-size:22px;line-height:1;">🕐</span>
            </div>
    ...
    <div class="col-md-3">
        <div class="kpi-card border-green">
            <div class="d-flex justify-content-between align-items-start mb-2">
                <div class="kpi-label mb-0">Approved</div>
                <span style="font-size:22px;line-height:1;">✅</span>
            </div>
    ...
    <div class="col-md-3">
        <div class="kpi-card border-blue">
            <div class="d-flex justify-content-between align-items-start mb-2">
                <div class="kpi-label mb-0">Products Available</div>
                <span style="font-size:22px;line-height:1;">📦</span>
            </div>
